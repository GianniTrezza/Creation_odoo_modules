...
# Fix da fare
# 1) Sistemare logica stati, senza passare da wizard; 

# 2) Visualizzare come nome pratica codice; 

# 3) Prevedere che una struttura sanitaria creata dalla pratica sia contrassegnata non come individual, ma come company e struttura sanitaria; 

# 4) Prevedere accreditamento di strutture non ancora accreditate; 

# 5) Page accreditamento solo per le company; 

# 6) Raggruppamento per tipologia ed anno; 

# 7) Quando clicco su Individual, il record non deve essere contrassegnata come struttura sanitaria. 

# 8) E’ un struttura sanitaria, solo se accedo alla sezione “Strutture Sanitarie”: non deve comparire nei contacts. 

# 9) La modificabilità riguarda solo in compilazione. 
